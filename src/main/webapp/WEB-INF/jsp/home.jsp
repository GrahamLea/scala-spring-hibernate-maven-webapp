...
<tags:head title="Scala/Spring/Hibernate/Maven Webapp">
    <meta name="description" content="A webapp built with Scala, Spring, Hibernate and Maven than can get your own web project kickstarted.">
...
<p>
    <ul>
        <c:forEach items="${customers}" var="customer">
            <li><a href="<c:url value="/customers/${customer.id}.html"/>"><c:out value="${customer.name}"/></a></li>
        </c:forEach>
    </ul>
</p>
</body>
